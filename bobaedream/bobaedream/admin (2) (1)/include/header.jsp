...
<!-- header S -->
	<div id="header">
		...
		<h1><a href="/"><img src="../images/admin/header/logo.gif" alt="버라이어티 쿠킹 클래스 Amy Cooking" /></a></h1>
		...
		<div class="member">
			...
			<dl>
				<dt>Administrator</dt>
				<dd>관리자</dd>
				<dd class="last"><a href="#" class="btn"><img src="../images/admin/header/logout.gif" width="50" height="22" alt="Logout" /></a></dd>
			</dl>
